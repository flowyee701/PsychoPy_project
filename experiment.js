...
function renderWelcomeScreen() {
  renderInstructionScreen(
    "Здравствуйте! Меня зовут Анна, я обучаюсь на 4 курсе факультета психологии и провожу исследование в рамках написания дипломной работы. Прохождение исследования не займет у Вас более 10 минут. Вас будет ждать несколько заданий, и перед каждым из них будет представлена краткая инструкция.",
